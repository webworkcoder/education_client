...
const country = {
  ...
  image: "/doc2.jpeg",
  description:
    "Russia is one of the most popular destinations for MBBS abroad due to its world-class medical universities, affordable tuition fees, globally recognized degrees, and experienced faculty. Medical universities in Russia provide excellent clinical exposure, modern infrastructure, and internationally accepted MBBS degrees for Indian students.",
};

const tableData = [
  { label: "Population", value: "146,000,000+ (as of 2024)" },
  {
    label: "Exchange Rate",
    value: "1 Russian Ruble = Approx ₹1.00 INR",
  },
  {
    label: "Climate",
    value: "Continental climate with cold winters and warm summers",
  },
  { label: "Location", value: "Eastern Europe & Northern Asia" },
  { label: "Capital", value: "Moscow" },
  { label: "Currency", value: "Russian Ruble (RUB)" },
  {
    label: "Travel time from Delhi",
    value: "Approximately 6–8 hours",
  },
  {
    label: "Time Difference",
    value: "+2:30 Hours ahead of IST",
  },
  {
  ...
  },
  {
    ...
    value: ["India", "China", "Egypt", "Bangladesh", "Nepal"],
  },
  {
...
const data = [
  {
    ...
    desc: "MBBS in Russia offers quality medical education at highly affordable tuition fees for Indian students.",
    dark: false,
  },
  {
    title: "Globally Recognized Universities",
    desc: "Medical universities in Russia are recognized by WHO, NMC, and other international medical organizations.",
    dark: false,
  },
  {
...
const safetyData = {
  description:
    "Russia is considered a safe destination for international students with supportive universities and student-friendly cities.",
  ...
  footer:
    "Following university guidelines and basic precautions ensures a safe and comfortable stay while studying MBBS in Russia.",
};

const advantagesData = {
  description:
    "Top advantages of studying MBBS in Russia for international students.",
...
const loanData = {
  description:
    "Education loans are available for Indian students planning to pursue MBBS in Russia.",
...
const faqs = [
  {
    qun: "Why should I study MBBS in Russia?",
    ans: "Russia offers affordable tuition fees, globally recognized universities, and quality medical education for international students.",
  },
  {
    qun: "Is NEET mandatory for MBBS in Russia?",
    ans: "Yes, NEET qualification is mandatory for Indian students pursuing MBBS in Russia.",
  },
  {
    qun: "Are Russian medical universities recognized by NMC?",
    ans: "Many medical universities in Russia are recognized by NMC, WHO, and other international medical organizations.",
  },
  {
    qun: "What is the duration of MBBS in Russia?",
    ans: "The MBBS course duration in Russia is generally 6 years including internship.",
  },
  {
    qun: "Is MBBS in Russia affordable for Indian students?",
    ans: "Yes, Russia provides affordable MBBS education with low tuition and living expenses.",
  },
];
