...
import { uzbekistanUniversities, kyrgyzstanUniversities, russiaUniversities, nepalUniversities } from "@/data/universities";
...
const UniversityDetails = () => {
  ...
  const allUniversities = [...uzbekistanUniversities, ...kyrgyzstanUniversities, ...russiaUniversities, ...nepalUniversities];
