...
import { uzbekistanUniversities, kyrgyzstanUniversities, russiaUniversities, nepalUniversities, bangladeshUniversities, georgiaUniversities, bosniaUniversities } from "@/data/universities";
...
const UniversityDetails = () => {
  ...
  const allUniversities = [...uzbekistanUniversities, ...kyrgyzstanUniversities, ...russiaUniversities, ...nepalUniversities, ...bangladeshUniversities, ...georgiaUniversities, ...bosniaUniversities];
