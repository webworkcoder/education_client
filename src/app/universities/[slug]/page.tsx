...
import { uzbekistanUniversities, kyrgyzstanUniversities, russiaUniversities, nepalUniversities, bangladeshUniversities } from "@/data/universities";
...
const UniversityDetails = () => {
  ...
  const allUniversities = [...uzbekistanUniversities, ...kyrgyzstanUniversities, ...russiaUniversities, ...nepalUniversities, ...bangladeshUniversities];
